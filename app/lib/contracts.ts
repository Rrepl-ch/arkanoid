 ...
 * Set NEXT_PUBLIC_ARKANOID_*_ADDRESS in .env
 */

export const ARKANOID_BALLS_ADDRESS =
  (process.env.NEXT_PUBLIC_ARKANOID_BALLS_ADDRESS as `0x${string}`) || '0x0000000000000000000000000000000000000000'

export const ARKANOID_GAMES_ADDRESS =
  (process.env.NEXT_PUBLIC_ARKANOID_GAMES_ADDRESS as `0x${string}`) || '0x0000000000000000000000000000000000000000'

export const ARKANOID_CHECKIN_ADDRESS =
  (process.env.NEXT_PUBLIC_ARKANOID_CHECKIN_ADDRESS as `0x${string}`) || '0x0000000000000000000000000000000000000000'

export const ARKANOID_NICKNAME_ADDRESS =
  (process.env.NEXT_PUBLIC_ARKANOID_NICKNAME_ADDRESS as `0x${string}`) || '0x0000000000000000000000000000000000000000'

/** ArkanoidBalls.sol variants may expose ownsBallType/hasBall/hasMinted. */
